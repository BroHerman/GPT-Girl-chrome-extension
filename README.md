...
6. Open `https://chatgpt.com/`. GPT-Girl will appear.
7. Use bottons at bottom-right to turn ON/OFF the GPT-Girl and music.
...
6. 打开 `https://chatgpt.com/` 开始使用，GPT 小女孩会自动出现。
7. 使用左下角的按钮来开启/关闭女孩和音乐。
